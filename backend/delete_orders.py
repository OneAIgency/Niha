...
from app.models.models import Order, SwapRequest, CashMarketTrade, MarketType
...
async def delete_all_orders():
    ...
    async with AsyncSessionLocal() as db:
        try:
            ...
            total_records = len(cash_orders) + len(swap_orders) + len(swap_requests) + len(trades)
...
async def main():
    ...
    try:
        response = input("Are you sure you want to delete ALL orders? (yes/no): ").strip().lower()
