...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('asset_type', postgresql.ENUM('EUR', 'CEA', 'EUA', name='assettype', create_type=True), nullable=False),
    ...
    op.create_index('ix_settlement_batches_batch_reference', 'settlement_batches', ['batch_reference'])
    op.create_index('ix_settlement_batches_entity_id', 'settlement_batches', ['entity_id'])
    op.create_index('ix_settlement_batches_order_id', 'settlement_batches', ['order_id'])
    op.create_index('ix_settlement_batches_trade_id', 'settlement_batches', ['trade_id'])
    op.create_index('ix_settlement_batches_settlement_type', 'settlement_batches', ['settlement_type'])
    op.create_index('ix_settlement_batches_status', 'settlement_batches', ['status'])
    op.create_index('ix_settlement_batches_expected_settlement_date', 'settlement_batches', ['expected_settlement_date'])
    ...
    op.create_index('ix_settlement_status_history_settlement_batch_id', 'settlement_status_history', ['settlement_batch_id'])
    op.create_index('ix_settlement_status_history_created_at', 'settlement_status_history', ['created_at'])
    ...
    op.add_column('orders', sa.Column('settlement_batch_id', postgresql.UUID(as_uuid=True), nullable=True))
    op.create_foreign_key('fk_orders_settlement_batch_id', 'orders', 'settlement_batches', ['settlement_batch_id'], ['id'])
    ...
    op.add_column('cash_market_trades', sa.Column('settlement_batch_id', postgresql.UUID(as_uuid=True), nullable=True))
    op.create_foreign_key('fk_cash_market_trades_settlement_batch_id', 'cash_market_trades', 'settlement_batches', ['settlement_batch_id'], ['id'])
    op.create_index('ix_cash_market_trades_settlement_batch_id', 'cash_market_trades', ['settlement_batch_id'])


def downgrade():
    # Remove columns from existing tables
    op.drop_index('ix_cash_market_trades_settlement_batch_id', 'cash_market_trades')
    op.drop_constraint('fk_cash_market_trades_settlement_batch_id', 'cash_market_trades', type_='foreignkey')
    ...
    op.drop_index('ix_settlement_status_history_created_at', 'settlement_status_history')
    op.drop_index('ix_settlement_status_history_settlement_batch_id', 'settlement_status_history')
    ...
    op.drop_index('ix_settlement_batches_expected_settlement_date', 'settlement_batches')
