 ...
 * >
 *   <button className="p-2.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-400">
...
export function Subheader({
  ...
  return (
    <div className={cn('bg-slate-900 border-b border-slate-800 px-6 py-4', className)}>
