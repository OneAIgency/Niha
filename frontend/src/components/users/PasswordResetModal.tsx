        ...
        <div className="p-6 space-y-4">
          <div className="p-4 bg-amber-900/20 rounded-lg border border-amber-800">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-white">Resetting password for:</p>
                <p className="text-sm text-navy-300">{userEmail}</p>
              </div>
            </div>
          </div>
          <Input
          ...
          <div className="flex items-center gap-3 p-3 bg-navy-700/50 rounded-lg">
            ...
            />
            <label htmlFor="forceChange" className="text-sm text-navy-200">
