...
export function DepthChart({ bids, asks }: DepthChartProps) {
  ...
  return (
    <div className="relative">
      {/* Y-axis labels */}
      <div className="absolute left-0 top-0 bottom-8 w-16 flex flex-col justify-between text-xs text-navy-500 tabular-nums">
      ...
      <div className="ml-16 mr-4">
        ...
        <div className="relative h-6 mt-2">
          {chartData.xLabels.map((label, idx) => (
            <div
              key={idx}
              className="absolute text-xs text-navy-500 tabular-nums"
              style={{
                left: `${label.x}%`,
