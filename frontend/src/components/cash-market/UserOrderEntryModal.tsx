  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        {/* Order Type Toggle */}
        <div>
          <label className="text-xs font-medium text-navy-300 block mb-1">
            Order Type
          </label>
          <div className="flex rounded-md overflow-hidden border border-navy-600">
            <button
              type="button"
        ...
        <div className={`grid ${orderType === 'LIMIT' ? 'grid-cols-3' : 'grid-cols-2'} gap-2`}>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-12 top-1/2 -translate-y-1/2 px-1.5 py-0.5 text-xs font-semibold text-emerald-400 hover:bg-emerald-900/30 rounded transition-colors z-10"
              >
                MAX
              </button>
            </div>
          ...
          <div>
            ...
            <div className="px-2 py-1.5 rounded-md border border-navy-600 bg-navy-900 text-white font-mono text-sm flex items-center justify-between">
              {isLoadingPreview ? (
        ...
        {/* Preview Section */}
        {isLoadingPreview && (
          <div className="flex items-center justify-center py-3 bg-navy-800 rounded-md border border-navy-600">
            <Loader2 className="w-4 h-4 animate-spin text-emerald-500 mr-1.5" />
            <span className="text-xs text-navy-400">Loading preview...</span>
          </div>
        )}

        {previewError && (
          <div className="flex items-start gap-1.5 p-2 bg-red-900/20 rounded-md border border-red-700">
        ...
        {preview && !isLoadingPreview && (
          <div className="p-2 bg-navy-800 rounded-md border border-navy-600 space-y-1.5">
            ...
            <div className="space-y-1 text-xs">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-mono font-semibold text-navy-400">
                  €{(preview.platformFeeAmount ?? 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                </span>
              </div>

              {/* Divider */}
              <div className="border-t border-navy-600 pt-1 mt-1">
                {/* Total Cost */}
                ...
                <div className="flex justify-between mt-1">
                  <span className="text-xs text-navy-400">Remaining Balance</span>
            ...
            {/* Execution Message */}
            {!preview.canExecute && (
              <div className="flex items-start gap-1.5 p-2 bg-red-900/20 rounded border border-red-700">
            ...
            {preview.canExecute && preview.willBePlacedInBook && (
              <div className="flex items-start gap-1.5 p-2 bg-blue-900/20 rounded border border-blue-700">
            ...
            {preview.canExecute && !preview.willBePlacedInBook && (
              <div className="flex items-start gap-1.5 p-2 bg-emerald-900/20 rounded border border-emerald-700">
