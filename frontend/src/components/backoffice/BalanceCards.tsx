        ...
        <div className="p-4 rounded-xl bg-emerald-900/20 border border-emerald-800">
          {showDetailed && balances.EUR ? (
            <>
              ...
              <div className="pt-3 border-t border-emerald-700 space-y-2">
                <div className="flex items-center justify-between text-xs">
                  <span className="text-emerald-400">Initial Balance</span>
        ...
        <div className="p-4 rounded-xl bg-amber-900/20 border border-amber-800">
          {showDetailed ? (
            <>
              ...
              {/* Initial and Locked - Secondary info */}
              <div className="pt-3 border-t border-amber-700 space-y-2">
                <div className="flex items-center justify-between text-xs">
                  <span className="text-amber-400">Initial Balance</span>
          ...
          {showDetailed ? (
            <>
              ...
              <div className="pt-3 border-t border-blue-700 space-y-2">
                <div className="flex items-center justify-between text-xs">
                  <span className="text-blue-400">Initial Balance</span>
