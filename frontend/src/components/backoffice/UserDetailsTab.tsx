        ...
        <>
          ...
          <Card>
            ...
            <div className="flex items-center gap-4 p-4 bg-navy-700/50 rounded-xl">
              ...
              <div>
                ...
                <p className="text-navy-400">{selectedUser.user.email}</p>
          ...
          <Card>
            ...
            {selectedUser.sessions.length > 0 ? (
                ...
                {selectedUser.sessions.map((session) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-mono text-sm text-white">{session.ipAddress}</p>
                        {session.isActive && (
              ...
              <p className="text-center text-navy-400 py-4">No sessions found</p>
            )}
          </Card>
          ...
          <Card>
            ...
            {selectedUser.trades.length > 0 ? (
              ...
              <p className="text-center text-navy-400 py-4">No trades found</p>
            )}
          </Card>
        </>
      )}
      ...
      {!selectedUser && !loading && (
        <Card>
          <div className="text-center py-12">
            ...
            <p className="text-navy-400">Search for a user to view their details</p>
          </div>
        </Card>
      )}
    </motion.div>
