        ...
        >
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="p-3 bg-navy-900/50 rounded-lg">
              <p className="text-sm text-navy-400">Creating user for:</p>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <h3 className={`font-semibold text-sm ${
                  mode === 'invitation' ? 'text-emerald-400' : 'text-navy-300'
                }`}>
                  Send Invitation
                </h3>
              ...
              >
                ...
                <h3 className={`font-semibold text-sm ${
                  mode === 'manual' ? 'text-blue-400' : 'text-navy-300'
                }`}>
                  Manual Creation
                </h3>
                <p className="text-xs text-navy-400 mt-1">
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-lg border border-navy-700 bg-navy-900 text-white focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
                />
              </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-3 py-2 rounded-lg border border-navy-700 bg-navy-900 text-white font-mono focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
                    />
                    <button
                      type="button"
                      onClick={generatePassword}
                      className="px-3 py-2 bg-navy-700 hover:bg-navy-600 rounded-lg text-navy-300 text-sm font-medium transition-colors"
                    >
                      Generate
                    </button>
                  </div>
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-2 mt-2">
                            <code className="flex-1 px-2 py-1 bg-navy-900 rounded font-mono text-sm text-white">
                              {generatedPassword}
                            </code>
                            <button
                              type="button"
                              onClick={copyPassword}
                              className="p-1.5 hover:bg-amber-800 rounded transition-colors"
                            >
                              {copied ? (
          ...
          {/* Footer */}
          <div className="flex items-center justify-end gap-3 p-4 border-t border-navy-700">
            <button
              type="button"
              onClick={onClose}
              disabled={loading}
