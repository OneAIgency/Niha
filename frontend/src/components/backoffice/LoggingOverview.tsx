      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-navy-800 rounded-lg p-6 border border-navy-700">
          ...
          <div className="space-y-3">
            {topActions.length === 0 ? (
              <p className="text-sm text-navy-400">No actions recorded</p>
            ) : (
        ...
        <div className="bg-navy-800 rounded-lg p-6 border border-navy-700">
          ...
          <div className="space-y-3">
            {!stats.byUser || stats.byUser.length === 0 ? (
              <p className="text-sm text-navy-400">No user activity recorded</p>
            ) : (
              stats.byUser.map((user) => {
                ...
                return (
                  <div key={user.userId} className="space-y-1">
                    <div className="flex items-center justify-between text-sm">
                      <span className="font-medium text-navy-300 truncate">
                        {user.email || 'System'}
